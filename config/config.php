...
$conf['settings']['script.url'] = 'http://local.rocket.co.in:8081/test/booked/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
 ...
 */
$conf['settings']['database']['type'] = 'mysqli';
 ...
 */
$conf['settings']['install.password'] = 'admin';
/**
 * Pages
 */
